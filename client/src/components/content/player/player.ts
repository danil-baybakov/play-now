            ...
            <div class="player flex">
                ...
                <div class="player__controls">
                    <div class="player__controls__header">
                        ...
                        <button class="player__skipback-btn"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <button class="player__repeat-btn ${this.props.status?.repeat ? "active" : ""}"><svg width="14" height="12" viewBox="0 0 14 12" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
